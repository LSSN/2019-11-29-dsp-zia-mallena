...
process = _*(ingain) : inmeter <: hgroup("[01]MAIN",qaqf,er8comb : si.bus(8),fbdel) :> vgroup("[02]OUTPUT METERS",h1meter,h2meter,h3meter,h4meter):> _,_ ;
